...
import com.vac.musicplayer.downloadmanager.DownLoader.DownLoadSuccess;
import com.vac.musicplayer.downloadmangaer.dbcontrol.DataKeeper;
import com.vac.musicplayer.downloadmangaer.dbcontrol.FileHelper;
...
public class DownLoadManager {
    ...
    public int addTask(String TaskID, String url, String fileName, String filepath) {
        ...
        DownLoader taskDownLoader = new DownLoader(mycontext, downloadinfo, pool,isSupportBreakpoint,true);
